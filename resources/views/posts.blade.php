<x-layout>
        ...
        <div class="mx-auto max-w-screen-md sm:text-center">
            <form action="">
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <div class="flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none">
                            <svg class="w-[18px] h-[18px] text-gray-800 dark:text-white" aria-hidden="true"
                                ...
                                viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-linecap="round" stroke-width="0.6"
                    ...
                    <div>
                        <button type="submit"
                            class="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-primary-600 border-primary-500 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Search</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="py-84px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0">
        ...
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <a href="/posts?author={{ $post->author['username'] }}">
                                ...
                                <span class="font-medium dark:text-white">
                                    {{ Str::limit($post->author->name, 15) }}</span>
                            </a>
                        </div>
                        <a href="/posts/{{ $post['slug'] }}"
            ...
            @empty
                <div>
                    <P class="font-semibold text-xl my-4 bg-red-100">Artikel Tidak Ditemukan</P>
                    <a href="/posts" class="block font-medium text-blue-500 ">&laquo; back To Posts </a>
                </div>
            @endforelse
        </div>
    </div>
